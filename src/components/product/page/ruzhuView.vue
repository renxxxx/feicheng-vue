  ...
  mounted() {
    ...
    console.log(this.options);
     ...
     if(this.$store.state.wxVideoaccount){
       ...
       this.dili={
       	shenfen:{
       		name:this.$store.state.wxVideoaccount.area1Name,
       		id:this.$store.state.wxVideoaccount.area1Id
       	},
       	city:{
       		name:this.$store.state.wxVideoaccount.area2Name,
       		id:this.$store.state.wxVideoaccount.area2Id
       	},
       	qu:{
       		name:this.$store.state.wxVideoaccount.area3Name,
       		id:this.$store.state.wxVideoaccount.area3Id
       	}
       }
      }
  },
