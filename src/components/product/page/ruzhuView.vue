  ...
  mounted() {
    ...
    console.log(this.options);
     ...
     if(this.getUserInfo){
       ...
       this.dili={
       	shenfen:{
       		name:this.$store.state.login.wxVideoaccount.area1Name,
       		id:this.$store.state.login.wxVideoaccount.area1Id
       	},
       	city:{
       		name:this.$store.state.login.wxVideoaccount.area2Name,
       		id:this.$store.state.login.wxVideoaccount.area2Id
       	},
       	qu:{
       		name:this.$store.state.login.wxVideoaccount.area3Name,
       		id:this.$store.state.login.wxVideoaccount.area3Id
       	}
       }
      }
  },
